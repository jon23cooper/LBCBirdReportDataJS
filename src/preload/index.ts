...
contextBridge.exposeInMainWorld('api', {
  ...
  locations: {
    ...
    listCache: () => ipcRenderer.invoke('locations:list-cache'),
    listCacheForLocation: (locationId: number) => ipcRenderer.invoke('locations:list-cache-for-location', locationId),
    deleteCacheEntry: (rawString: string) => ipcRenderer.invoke('locations:delete-cache-entry', rawString),
